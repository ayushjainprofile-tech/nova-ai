        ...
        <main className="flex-1 min-w-0 flex flex-col overflow-hidden bg-white rounded-[28px] shadow-soft">
          ...
          <div className="flex items-center justify-between p-6 border-b border-black/5">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-lg font-bold">ProspectIQ Assistant</h2>
              ...
              {messages.map((msg, idx) => (
                ...
                >
                  <div className={`max-w-[75%] rounded-2xl p-4 ${
                    ...
                    {msg.lead && (
                       <div className="mt-4 bg-white border border-brand-yellow/30 rounded-xl p-4 shadow-sm">
          ...
          <div className="p-6 pt-0">
            <div className="flex items-end gap-3 bg-canvas p-2 rounded-[24px] border border-black/5">
              <button className="grid h-[50px] w-[50px] shrink-0 place-items-center rounded-full text-ink-soft hover:bg-white hover:text-ink transition">
              ...
              <textarea
                ...
                className="flex-1 bg-transparent max-h-[120px] min-h-[50px] resize-none py-3 px-2 text-[15px] font-medium text-ink placeholder:text-ink-soft/60 outline-none scrollbar-none"
                rows={1}
              />
              <button className="grid h-[50px] w-[50px] shrink-0 place-items-center rounded-full text-ink-soft hover:bg-white hover:text-ink transition">
